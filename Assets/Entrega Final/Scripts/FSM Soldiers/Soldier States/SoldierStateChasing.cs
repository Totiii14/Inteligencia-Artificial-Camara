...
public class SoldierStateChasing : State
{
    ...
    public SoldierStateChasing(FSMIASoldiers fsm, SteeringEntity steering, Rigidbody rb, ObstacleAvoid obstacleAvoid, Transform transform, LineOfSight los, Animator animator,
        float maxVelocity, float timePrediction)
    {
        _fsm = fsm;
        _steering = steering;
