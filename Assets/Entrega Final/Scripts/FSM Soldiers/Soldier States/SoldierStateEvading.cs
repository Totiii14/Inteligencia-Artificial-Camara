...
public class SoldierStateEvading : State
{
    ...
    public SoldierStateEvading(FSMIASoldiers fsm, SteeringEntity steering, Rigidbody rb, ObstacleAvoid obstacleAvoid, Animator animator, 
        Transform transform, float maxVelocity, float timePrediction)
    {
        _fsm = fsm;
        _steering = steering;
